...
def test_cbr_thickness_interpolation(case_id: str, cbr: float, coverages: float) -> None:
    ...
    computed, _was_clamped, _was_extrapolated = interpolate_thickness(_CURVE_DATA, cbr, coverages)
...
class TestCBRThicknessMonotonicity:
    ...
    def test_thickness_increases_with_coverages(self) -> None:
        ...
        t_low, _, _ = interpolate_thickness(_CURVE_DATA, cbr=5, coverages=100)
        t_high, _, _ = interpolate_thickness(_CURVE_DATA, cbr=5, coverages=10000)
        assert t_high > t_low, (
    ...
    def test_thickness_decreases_with_cbr(self) -> None:
        ...
        t_weak, _, _ = interpolate_thickness(_CURVE_DATA, cbr=3, coverages=1000)
        t_strong, _, _ = interpolate_thickness(_CURVE_DATA, cbr=15, coverages=1000)
    ...
    def test_case_a_thicker_than_case_c(self) -> None:
        ...
        t_a, _, _ = interpolate_thickness(_CURVE_DATA, cbr=3, coverages=1000)
        t_c, _, _ = interpolate_thickness(_CURVE_DATA, cbr=15, coverages=50000)
        assert t_a > t_c, (
